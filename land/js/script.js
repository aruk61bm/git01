...
(function () {
    ...
    function initiate() {
        ...
        function start_timer() {
            let timerInterval;
            let hours = document.querySelectorAll(".flex-timer .hours");
            let minutes = document.querySelectorAll(".flex-timer .minutes");
            let seconds = document.querySelectorAll(".flex-timer .seconds");
            let points = document.querySelectorAll(".flex-timer .points");
            ...
            minutes.forEach(function (elem) {
                elem.innerHTML = twoDigit(minutesLeft);
            });
            seconds.forEach(function (elem) {
                elem.innerHTML = twoDigit(secondsLeft);
            });
